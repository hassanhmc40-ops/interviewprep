    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center text-sm text-slate-500 mb-6">
                ...
                <span class="text-slate-900 font-medium">Create Domain</span>
            </div>

            <!-- Form Card -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                <h1 class="text-2xl font-bold text-slate-900 mb-6">Create New Domain</h1>
                ...
                <form method="POST" action="{{ route('domains.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-3 flex items-center">
                            <span class="text-sm text-slate-500 mr-2">Selected:</span>
                            <div id="selectedColor" class="w-5 h-5 rounded-full border border-slate-200" style="background-color: #3B82F6"></div>
                            <span id="colorCode" class="ml-2 text-sm text-slate-600 font-mono">#3B82F6</span>
                        </div>
                        @error('color')
                            <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                        @enderror
